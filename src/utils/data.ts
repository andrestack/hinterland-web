export const services = [
  {
    ...
    description:
      "We craft websites that reflect your unique brand and personality, helping you attract more clients and increase visibility. The fact that we use different technologies and frameworks, allows us to offer a more tailored solution for your needs.",
